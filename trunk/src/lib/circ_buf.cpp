...
CircularBuffer::CircularBuffer() {
  ...
  m_uiSize=dsize;	//size of the queue
  					//may be overwritten with setSize
...
int CircularBuffer::insert(const char* buf, int n, int& start, int& end) {
	...
	an=m_uiSize-m_uiTotEl;	//empty space in the queue 
							//(size of the queue-total number of elements in it)
...
/*
  set the size of the queue: init the "m_uiSize" and "m_buf"
  -1 error
  1 successful
*/
